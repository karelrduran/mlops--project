...
class DataPreprocessor:
    ...
    def cleaning_data(self, df):
        ...
        df = df.map(lambda x: None if x == 'Unknown' else x)
        return df
    ...
    def preprocess(self):
        ...
        self.export_preprocessing_models(imputer_cat, imputer_num, encoder, norm_scaler, stand_scaler,
                                         preprocess_models_path)
    ...
    def export_feature_names(self):
        ...
        pd.DataFrame(self.original_feature_names, columns=["Feature Names"]).to_csv(original_feature_names_path,
                                                                                    index=False)
